/**
  ******************************************************************************
  * @file    stm32h745i_discovery_bus.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to communicate
  *          with  external devices available on STM32H745I-DISCO board (MB1381) from
  *          STMicroelectronics
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32H745I_DISCO_BUS BUS
  * @{
  */

/** @defgroup STM32H745I_DISCO_BUS_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32H745I_DISCO_BUS_Private_Types Private Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32H745I_DISCO_BUS_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32H745I_DISCO_BUS_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32H745I_DISCO_BUS_Private_FunctionPrototypes BUS Private FunctionPrototypes
  * @{
  */
...
/** @defgroup STM32H745I_DISCO_BUS_Exported_Functions Exported Functions
  * @{
  */
...
/** @defgroup STM32H745I_DISCO_BUS_Private_Functions Private Functions
  * @{
  */
/**
