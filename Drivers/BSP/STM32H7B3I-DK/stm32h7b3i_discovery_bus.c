/**
  ******************************************************************************
  * @file    stm32h7b3i_discovery_bus.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to communicate
  *          with  external devices available on STM32H7B3I-DK board (MB1332) from
  *          STMicroelectronics
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32H7B3I_DK_BUS BUS
  * @{
  */

/** @defgroup STM32H7B3I_DK_BUS_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32H7B3I_DK_BUS_Private_TypesPrivate Private Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32H7B3I_DK_BUS_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32H7B3I_DK_BUS_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32H7B3I_DK_BUS_Private_FunctionPrototypes Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32H7B3I_DK_BUS_Exported_Functions Exported Functions
  * @{
  */
/**
